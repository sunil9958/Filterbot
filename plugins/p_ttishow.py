...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url=https://t.me/svfilmsx_official)
                 ],[
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="http://t.me/Sunil_v99")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            ...
            InlineKeyboardButton('Owner', url="http://t.me/Sunil_v99")
        ],[
